...
public class M1405_rename extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.m_add://新增
                it.setClass(M1405_rename.this, M1405insert.class);
                startActivity(it);
                break;
            case R.id.m_query://查詢
                it.setClass(M1405_rename.this, M1405query.class);
                startActivity(it);
                break;
            case R.id.m_update://編輯刪除
                it.setClass(M1405_rename.this, M1405update.class);
                startActivity(it);
                break;
            ...
            case R.id.m_batch://批次新增
                ...
                break;
            case R.id.m_spinner:
                it.setClass(M1405_rename.this, M1405.class);
                startActivity(it);
                break;
            case R.id.m_clear:
                MyAlertDialog aldDial = new MyAlertDialog(M1405_rename.this);
                ...
                break;
            case R.id.m_list:
                it.setClass(M1405_rename.this,M1405list.class);
                startActivity(it);
                break;
    ...
    private DialogInterface.OnClickListener aldBtListener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            Toast.makeText(M1405_rename.this, msg, Toast.LENGTH_SHORT).show();
        }
    };
}
