package tw.tcnr21.m1405.providers;
...
public class FriendsContentProvider extends ContentProvider {
    private static final String AUTHORITY = "tw.tcnr21.m1405.providers.FriendsContentProvider";
...
//        String aa = "a";
    ...
    @Override
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) { //selection選擇的欄位
