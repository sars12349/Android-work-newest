...
public class M1421 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    String t_id, tname, tgrp, taddress;
    ...
    private void u_layout_def() { //--layout 初始值
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnabandon: //按下放棄鈕
                Toast.makeText(M1421.this, "*返回編輯處理*", Toast.LENGTH_SHORT).show();
                u_menu_edit_main();
    ...
    private void dbmysql() {
        ...
        try {
            ...
            if (jsonArray.length() > 0) { // MySQL 連結成功有資料
                ...
                Toast.makeText(M1421.this, "主機資料庫無資料", Toast.LENGTH_LONG).show();
            }
            // --------------------------------------------------------
        } catch (Exception e) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.m_batch://批次新增
                ...
                tvTitle.setText("顯示資料： 共" + tcount + " 筆");
                msg = "新增記錄  成功 ! ";
                Toast.makeText(M1421.this, msg, Toast.LENGTH_SHORT).show();
                c.close();
            ...
            case R.id.m_clear://清空資料
                // 清空
                MyAlertDialog aldDial = new MyAlertDialog(M1421.this);
