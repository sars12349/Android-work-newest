...
public class LiteListDemoActivity extends AppCompatActivity {
    ...
    /**
     * Adapter that displays a title and {@link MapView} for each item.
     ...
     * When the {@link #onMapReady(GoogleMap)} callback is received and
     * the {@link GoogleMap} is ready, it stored in the {@link #map}
