...
public class CircleImgbutton extends android.support.v7.widget.AppCompatImageButton {
    private Paint paint = new Paint();

    public CircleImgbutton(Context context) {
        super(context);
    }

    public CircleImgbutton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircleImgbutton(Context context, AttributeSet attrs, int defStyleAttr) {
