...
import tw.tcnr01.m1417.R;

public class M1417test extends AppCompatActivity implements View.OnClickListener {
    String sqlctl;
    String TAG = "tcnr21=>";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.m1417test);
        setupViewComponent();
//-------------抓取遠端資料庫設定執行續------------------------------
...
//------------------------------------------------------
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                TableRow tr = new TableRow(M1417test.this);
...
//    tr.setGravity(Gravity.CENTER_HORIZONTAL);
                while (itt.hasNext()) {
                    ...
                    // --
                    TextView tv = new TextView(M1417test.this);// tv 繼承TextView
